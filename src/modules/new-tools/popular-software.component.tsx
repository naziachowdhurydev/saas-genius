      ...
      <Container>
        <div className="space-y-2 px-10 lg:px-0">
          ...
          <p className="text-xl md:text-2xl">
            Dive into our curated collection of groundbreaking AI and SaaS tools
            designed to revolutionize your workflow and boost productivity.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between items-center mt-12 space-y-7 lg:space-y-0">
          ...
          <div className="">
            <button className="flex gap-2 items-center py-4 px-20 border bg-gray-50 text-black hover:bg-gray-100 rounded-[10px] ">
...
PopularSoftware.displayName = "PopularSoftware";
